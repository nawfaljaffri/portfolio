      ...
      <footer className="w-full max-w-[1300px] mx-auto border-t border-gray-200 bg-white px-6 md:px-12 py-8 mt-4 mb-0 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        ...
        <div className="text-left md:text-right flex flex-col items-start md:items-end">
          <CursorHover text="COPY">
            <a href="mailto:nawfaljafri@gmail.com" className="text-lg font-bold tracking-tight hover:opacity-50 transition-opacity inline-block">
              nawfaljafri@gmail.com
            </a>
          </CursorHover>
          <CursorHover text="CONNECT">
            <a href="https://www.linkedin.com/in/nawfaljaffri/" target="_blank" rel="noopener noreferrer" className="text-xs font-bold uppercase tracking-widest text-gray-400 hover:text-black transition-colors mt-2 inline-block">
              LinkedIn
            </a>
          </CursorHover>
        </div>
